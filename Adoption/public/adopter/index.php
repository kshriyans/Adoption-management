...
$sql = sprintf("SELECT o.OId, o.OrgName, o.Address1, o.Address2, o.City, o.State, o.Photo, o.Website,
		o.Phone FROM orphanage AS o WHERE City='%s' ORDER BY Children
		DESC LIMIT 5", $city);

$sql_2 = "SELECT OId, o.OrgName, o.Address1, o.Address2, o.City, o.State, o.Photo, o.Website,
		o.Phone FROM orphanage AS o ORDER BY Children
		DESC LIMIT 5";
