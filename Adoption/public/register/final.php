                        ...
                        <div class="row tac">
                            ...
                            <?php
								...
								if(isset($_GET["alert"]) && $_GET["alert"] == "success")
								{
									...
									<h2 style="color: #0A0; font-size: 18px; text-align: center;">Successful!</h2>' . $_SESSION["success"] . '. <a href="http://'. htmlspecialchars($_SERVER["HTTP_HOST"]) .'/Adoption/public/login.php">Login</a> to your account.</div>';
								}
                            ?>
